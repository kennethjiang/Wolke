...
$this->_smarty_include(array('smarty_include_tpl_file' => "inc/intable_header.tpl", 'smarty_include_vars' => array('header' => "确认关闭服务器组",'color' => 'Gray')));
...
" style="margin-left:20px;">
			...
			<br />
				<input style="vertical-align:middle;" type="checkbox" name="untermonfail" value="1"> 当有任何一个服务角色的同步失败时，不要关闭服务器组
			</div>
		</div>
	<?php endif; ?>
	</td>
