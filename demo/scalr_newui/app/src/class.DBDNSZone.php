<?php
	...
	{			
		...
		public static function create($zoneName, $soaRefresh, $soaExpire, $soaOwner, $soaRetry = 7200)
		{
			...
			$zone->soaTtl = CONFIG::$DEF_SOA_TTL;
			$zone->soaParent = CONFIG::$DEF_SOA_PARENT;
			$zone->soaSerial = date("Ymd")."01";
			$zone->soaRetry = $soaRetry ? $soaRetry : CONFIG::$DEF_SOA_RETRY;
			$zone->soaMinTtl = CONFIG::$DEF_SOA_MINTTL;
