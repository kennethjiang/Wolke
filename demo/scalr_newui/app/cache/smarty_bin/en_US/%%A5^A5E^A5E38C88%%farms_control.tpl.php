...
unset($_smarty_tpl_vars);
 ?>
    			<?php if ($this->_tpl_vars['farminfo']['status'] == 1): ?>
	    			<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "inc/table_footer.tpl", 'smarty_include_vars' => array('button2' => 1,'button2_name' => "同步选中的服务器内容，并关闭云平台",'button3' => 1,'button3_name' => "忽略同步，直接关闭服务器",'cancel_btn' => 1)));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
 				<?php else: ?>
